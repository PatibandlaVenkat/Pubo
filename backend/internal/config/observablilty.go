...
type ObservabiltiyConfig struct{
...
func DefaultObservablityConfig() *ObservabiltiyConfig{
	return &ObservabiltiyConfig{
		ServiceName:"pubo",
...
func (c *ObservabiltiyConfig) Validate() error{
	if c.ServiceName==""{
...
func(c*ObservabiltiyConfig) GetLogLevel() string{
...
func (c*ObservabiltiyConfig) IsProduction() bool{
